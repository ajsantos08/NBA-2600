...
start:
 ...
 lda #$FA 	; change background colour to red, border to black 
 sta $900f
 ...
 ldy #$0f		; 'O' for collision
 sty $1ef1		; Right middle
 lda #$05	
 sta $1000		; row
 lda #$0a
 sta $1001		; col
...
collision:		 ; detect collision between B and C
 ...
 cpy #$04
 beq defense
 cpy #$0f		; check if character is 'C'
